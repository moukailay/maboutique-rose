  ...
  const updateProductMutation = useMutation({
    ...
    onError: (error: any) => {
      ...
      toast({
        ...
        description: error.message || "Une erreur s'est produite lors de la modification du produit.",
        variant: "destructive",
      });
    },
  });
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="Ex: Miel de lavande bio" {...field} />
                        </FormControl>
                        <FormDescription>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Une description détaillée aide vos clients à comprendre votre produit
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                          ...
                          {selectedImages.length === 0 && (
                            <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                              ...
                              <p className="text-sm text-gray-400">
                                Cliquez sur "Changer l'image" pour ajouter une photo
                              </p>
                            </div>
                          )}
                        </div>
